	...
	public boolean admin_email(Bean bean) {
		// TODO Auto-generated method stub
		  ...
		  try
		  {
			...
			PreparedStatement ps=con.prepareStatement("select admin_email from admin_details where admin_email=? ");
		...
		// TODO Auto-generated method stub
		 Connection con= null;
		  ...
		  try
		  {
			...
			PreparedStatement ps=con.prepareStatement("select admin_password from admin_details where admin_email=? ");
			ps.setString(1,bean.getAdmin_email() );
			ResultSet rs=ps.executeQuery();
